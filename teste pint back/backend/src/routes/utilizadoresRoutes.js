...
const { atualizarFoto, atualizarPerfil, getRanking, atualizarFotoBase64, atualizarRgpd } = require('../controllers/utilizadoresController');
...
router.put('/:id/rgpd',          atualizarRgpd);
